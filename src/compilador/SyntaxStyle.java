 ...
 */
public class SyntaxStyle extends AbstractTokenMaker{
...
public TokenMap getWordsToHighlight() {
   ...
   tokenMap.put("Numeric", Token.DATA_TYPE);
   tokenMap.put("Boolean", Token.DATA_TYPE);
   tokenMap.put("Null", Token.DATA_TYPE);
  
   tokenMap.put("Read(", Token.FUNCTION);
   tokenMap.put("=Read(", Token.FUNCTION);
   tokenMap.put("Write(",  Token.FUNCTION);
   
   tokenMap.put("true",  Token.OPERATOR);
   tokenMap.put("false",  Token.OPERATOR);
   
   tokenMap.put("And",  Token.OPERATOR);
   tokenMap.put("Or",  Token.OPERATOR);
   
   tokenMap.put("Inc",  Token.SEPARATOR);
   return tokenMap;
}
@Override
